class Solution {
    ...
    topKFrequent(nums, k) {
       ...
       const newEntries = Object.entries(numMaps).map(ele=>[ele[1], ele[0]])
       console.log(newEntries)

       const sortedNewEntries = newEntries.sort((a,b)=>b[0] - a[0]).splice(0,k)
        console.log(sortedNewEntries)

       const result = sortedNewEntries.map(ele=>ele[1])
